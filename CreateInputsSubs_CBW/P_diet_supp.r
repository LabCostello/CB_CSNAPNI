...
if(print_tags == 1){
  print("CreateInputsSubs_CBW/P_diet_supp.R")
}
...
#write data files
write_name = paste("InputFiles_CBW/Psupp_peranim.txt",sep = "") #kg P supplementation per animal for each livestock category in each year
write.table(Psupp_peranim, file = write_name, sep = " ", row.names = FALSE, col.names = FALSE)
write_name = paste("InputFiles_CBW/Psupp_animtotals.txt",sep = "") #total kg P supplementation for each livestock category in each year
write.table(Psupp_animtotals, file = write_name, sep = " ", row.names = FALSE, col.names = FALSE)
write_name = paste("InputFiles_CBW/Psupp_total.txt",sep = "") #total kg P supplementation in each year
