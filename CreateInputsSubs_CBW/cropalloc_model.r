...
cropgrainNprop=array(0, c(n_crops,data_yrs)) #this crop's proportional contribution to total N in grain
...
for(n in 1:data_yrs){
  ...
  #write data files
  write_name = paste("InputFiles_CBW/cropNtoanim",model_yrs[n],".txt",sep = "") #kg N by crop per animal in each livestock category
  write.table(cropNtoanim[,,n], file = write_name, sep = " ", row.names = FALSE, col.names = FALSE)
  write_name = paste("InputFiles_CBW/cropPtoanim",model_yrs[n],".txt",sep = "") #kg P by crop per animal in each livestock category
  write.table(cropPtoanim[,,n], file = write_name, sep = " ", row.names = FALSE, col.names = FALSE)
  write_name = paste("InputFiles_CBW/cropkgtoanimtotal_N",model_yrs[n],".txt",sep = "") #kg crop/animal type/year, based on N requirement allocation
  write.table(cropkgtoanimtotal_N[,,n], file = write_name, sep = " ", row.names = FALSE, col.names = FALSE)
  write_name = paste("InputFiles_CBW/cropkgtoanimtotal_P",model_yrs[n],".txt",sep = "") #kg crop/animal type/year, based on P requirement allocation
