...
if(print_tags == 1){
  print("CreateInputsSubs_CBW/export_data.R")
}
...
for (i in 1:length(import_yrs1)) {
  ...
  exports[2,i] <- cropprodtotal[2,i]*0.4057 # Corn Silage
  exports[3,i] <- cropprodtotal[3,i]*0.8858 # Wheat
  exports[10,i] <- cropprodtotal[10,i]*0.7590 # Alfalfa Hay
  exports[11,i] <- cropprodtotal[11,i]*0.5224 # Other Hay
