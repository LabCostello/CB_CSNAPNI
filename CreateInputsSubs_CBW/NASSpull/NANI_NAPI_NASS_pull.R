...
if(print_tags == 1){
  print("CreateInputsSubs_CBW/NASSpull/NANI_NAPI_NASS_pull.R")
}
...
source("CreateInputsSubs_CBW/NASSpull/NASS_national.R") #pulls the national level data for the specified queries
